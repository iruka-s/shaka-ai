...
def analyze_sentence(sentence):
    ...
    for chunk_index in range(tree.chunk_size()):
        ...
        for word_index  in range(chunk.token_pos,chunk.token_pos + chunk.token_size):
            ...
            # print(tree.token(word_index).surface, end=" : ")
            # print(tree.token(word_index).feature)
...
if __name__ == '__main__':
    ...
    # sentence = "私は今日横断歩道で困っているおばあさんを助けた"
    # sentence = "私は今日横断歩道で困っているおばあさんを助けたせいで仕事に遅刻し、上司にひどく怒られた"
    # sentence = "私は今日横断歩道で困っているおばあさんを助けたせいで仕事に遅刻したが、上司に怒られず、安心した。明日はいい天気になる。"
    sentence = "私はさぼらなかった。"
    # sentence = "彼は悪いことはしないと信じている"
    # sentence = "私は勉強した"
